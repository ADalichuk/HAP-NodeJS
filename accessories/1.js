...
var DHT_SENSOR = {
  ...
  read() {
    ...
    console.log("DHT sensor on pin " + sensorPin + " t=" + data.temperature + " h=" + data.humidity);
...
var sensor = exports.accessory = new Accessory('DHT Sensor1', uuid.generate('hap-nodejs:accessories:temperature-sensor1'));

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
sensor.username = "C1:4A:3A:AE:4E:FA";
sensor.pincode = "031-45-154";

// Add the actual TemperatureSensor&HumiditySensor Service.
// We can see the complete list of Services and Characteristics in `lib/gen/HomeKitTypes.js`
sensor
  .addService(Service.TemperatureSensor, "T_IN")
...
sensor
  .addService(Service.HumiditySensor, "H_IN")
